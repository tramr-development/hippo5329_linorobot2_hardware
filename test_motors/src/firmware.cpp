...
NoReverseMotor motor1_controller(PWM_THRESHOLD, PWM_FREQUENCY, PWM_BITS, MOTOR1_INV, MOTOR1_PWM, MOTOR1_IN_A, MOTOR1_IN_B);
NoReverseMotor motor2_controller(PWM_THRESHOLD, PWM_FREQUENCY, PWM_BITS, MOTOR2_INV, MOTOR2_PWM, MOTOR2_IN_A, MOTOR2_IN_B);
